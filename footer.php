            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="footer-gallery lightbox" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
                            <a href="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/1.jpg">
                                <img src="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/1-small.jpg" width="106" height="70" alt="" />
                            </a>
                            <a href="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/2.jpg">
                                <img src="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/2-small.jpg" width="106" height="70" alt="" />
                            </a>
                            <a href="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/3.jpg">
                                <img src="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/3-small.jpg" width="106" height="70" alt="" />
                            </a>
                            <a href="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/4.jpg">
                                <img src="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/4-small.jpg" width="106" height="70" alt="" />
                            </a>
                            <a href="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/5.jpg">
                                <img src="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/5-small.jpg" width="106" height="70" alt="" />
                            </a>
                            <a href="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/6.jpg">
                                <img src="<?php echo get_template_directory_uri() ;?>/assets/images/footer-gallery/6-small.jpg" width="106" height="70" alt="" />
                            </a>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <form method="post" action="<?php echo get_home_url() ?>?na=s" onsubmit="return newsletter_check(this)">                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                <input type="email" id="email" name="ne" class="form-control required" placeholder="Enter your Email">
                        ...
                        <!-- Social Icons -->
                        <div class="mt-20">
                            <a href="https://www.facebook.com/pages/South-Wicklow-Drama-Festival/338388519392" class="social-icon social-icon-border social-facebook float-left" data-toggle="tooltip" data-placement="top" title="Facebook" target="_blank">

                                <i class="icon-facebook"></i>
                                <i class="icon-facebook"></i>
                            </a>

                            <a href="https://twitter.com/SouthWicklowDF" class="social-icon social-icon-border social-twitter float-left" data-toggle="tooltip" data-placement="top" title="Twitter" target="_blank">
